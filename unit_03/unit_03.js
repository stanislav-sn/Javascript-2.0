...
function f4() {
    ...
    let years = now.getFullYear() - input.value;
    if (years >= 18) {
        div.innerHTML = 1;
    } else {
        div.innerHTML = 0;
...
function f8(){
    ...
    const input = document.querySelector('.s-8');
    let num = +input.value;
    switch (num) {
        case 1:
            div.innerHTML = 'one';
...
function f10(){
    ...
    const input = document.querySelector('.s-100');
    let num = input.value;
    div.innerHTML = num;
}
...
function f11(){
    ...
    // const input = document.querySelector('.s-110');
    // let num = select.value;
    // div.innerHTML = num;    НЕ РАБОТАЕТ ! ! ! !
}
...
const sel = document.querySelector('.s-143');

function f14(){
    let num1 = +i141.value;
    let num2 = +i142.value;
    const oper = sel.value;
    if (oper === '+') {
