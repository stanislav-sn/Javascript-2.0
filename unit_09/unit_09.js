...
function f5() {
    let out = document.querySelector('.out-4'),
        outFive = document.querySelector('.out-5'),
        bg = document.querySelector('.bg-4');
    if (out === bg) {
        outFive.innerHTML = true;
    } else {
        outFive.innerHTML = false;
    }
}
...
function f11() {
    ...
    let out = document.querySelector('.out-11').append(div);
    div.innerHTML = '25';
...
function f12() {
    ...
    let out = document.querySelector('.out-12').append(div);
    div.innerHTML = '12';
...
function f13() {
    let div = document.createElement('div');
    let out = document.querySelector('.out-13').append(div);
    div.classList.add('bg-12');
...
function f14() {
    ...
    let out = document.querySelector('.out-14').prepend(div);
    div.innerHTML = '14';
}
...
function f15() {
    ...
    let out = document.querySelector('.out-15').before(div);
    div.innerHTML = '15';
}
...
function f16() {
    ...
    let out = document.querySelector('.out-16').after(div);
    div.innerHTML = '16';
}
...
function f17() {
    ...
    let out = document.querySelector('.out-17').replaceWith(div);
    div.innerHTML = '17';
}
...
function f18() {
    let attr = document.querySelector('.p-18');
    let out = document.querySelector('.out-18');
    out.innerHTML = attr.getAttribute('data-b');
}
