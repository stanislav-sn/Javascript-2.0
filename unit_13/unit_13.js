...
function f6() {
    let out = '',
        i_1 = document.querySelector('.i-61').value,
        i_2 = document.querySelector('.i-62').value;
    a6[i_1] = i_2;
    for (let key in a6) {
        out += `${key}: ${a6[key]} <br>`;
    }
...
function f7() {
    let out = '',
        i_1 = document.querySelector('.i-7').value;
    for (let key in a7) {
        if (key == i_1) {
            out = 1;
            break;
...
function f8() {
    let out = '',
        i_1 = document.querySelector('.i-8').value;
    for (let key in a8) {
        if (key == i_1) {
            out = a8[key];
            break;
...
function f9() {
    let out = '',
        inputValue = +document.querySelector('.i-9').value;
    for (let key in a9) {
...
function f11() {
    let out = '',
        inpValue = document.querySelector('.i-11').value;
    for (let key in a11) {
        if (key === inpValue) {
            delete key;
        }
...
function f12() {
    let out = '',
        inpValue = +document.querySelector('.i-12').value;
    for (let key in a12) {
        if (a12[key] === inpValue) {
            delete a12[key];
        }   
...
function f18() {
    let out = '',
        inpValue = document.querySelector('.i-18').value;
    for (let key in a18) {
        if (key === inpValue) {
            out += `${a18[key]} `;
        }
...
function f19() {
    let out = '',
        inpValue = document.querySelector('.i-19').value;
    for (let key in a19) {
        for (let i = 0; i < a19[key].length; i++) {
            if (inpValue. == a19[key][i]) {
                out = key;
            }
        }
    }
