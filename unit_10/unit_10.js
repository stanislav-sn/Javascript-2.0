...
let ar6 = ['Stas', 'Козерог', 15, 'января'];
...
let ar8 = [3,4,55,23,44,2,3,4,5,9];
...
function f8() {
    ...
    out8_1 = ar8.length;
    document.querySelector('.out-8-1').innerHTML = out8_1;
}
...
function f19() {
    ...
    document.querySelector('.out-19').innerHTML = indexMin;
}
